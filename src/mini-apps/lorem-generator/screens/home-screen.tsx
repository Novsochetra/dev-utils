  ...
  return (
    <div className="min-h-screen w-full flex flex-col">
      ...
      <div className="flex flex-col items-center justify-center p-8 ">
        ...
        >
          <div className="flex">
            <Input className="flex flex-1 mr-4" type="number" placeholder="Enter amount" value={parseInt(String(amount))} onChange={e => {
            ...
            <Select defaultValue={GenerateMode.Paragraph} onValueChange={(v: GenerateMode) => {
              ...
              <SelectContent>
                <SelectItem value={GenerateMode.Paragraph}>Paragraph</SelectItem>
